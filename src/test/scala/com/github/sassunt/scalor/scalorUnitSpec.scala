...
class ScalorUntSpec extends Specification {
  ...
  ":# method" should {
    ...
    "return Font for Color" in {
      ...
      font1.params.color mustEqual yellow
      font1.params.tone mustEqual plain
      font1.params.bgColor mustEqual default
      font1.params.decors mustEqual List(default)
  ...
  ":~ method" should {
    ...
    "return Font for Background" in {
      val font1 = "YELLOW" :~ yellow
      font1.text mustEqual "YELLOW"
      font1.params.color mustEqual default
      font1.params.tone mustEqual plain
      font1.params.bgColor mustEqual yellow
      font1.params.decors mustEqual List(default)
  ...
  ":@ method" should {
    ...
    "return Font for Decor" in {
      ...
      font1.params.tone mustEqual plain
      font1.params.bgColor mustEqual default
      font1.params.decors mustEqual List(underline, default)
